...
import { Home, Compass, Library, ShieldAlert, User } from "lucide-react";
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-[#050507]/95 backdrop-blur-lg border-t border-[#1F1F28] px-4 py-2 z-50">
