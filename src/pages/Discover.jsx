  ...
  return (
    <div className="p-4 pb-36 space-y-6">
      <header className="pt-2">
        ...
        <p className="text-xs text-gray-400">Filtre faixas underground baseadas no seu gosto.</p>
      </header>
      ...
      <section className="space-y-3">
        {loading ? (
          <div className="text-center py-10 text-xs text-gray-500">Filtrando o catálogo...</div>
        ) : (
          tracks.map((track) => (
            <div
              key={track.id}
