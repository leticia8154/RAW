  ...
  return (
    <div className="p-4 pb-36 space-y-6">
      ...
      <section className="space-y-3">
        ...
        {loading ? (
          <div className="text-xs text-gray-500 py-8 text-center">Carregando recomendações...</div>
        ) : tracks.length > 0 ? (
          ...
          <div className="text-xs text-gray-500 py-6 text-center">Nenhuma música encontrada.</div>
        )}
      </section>
      ...
      <section className="space-y-3">
        ...
        {featuredArtists.length > 0 ? (
          ...
          <div className="text-xs text-gray-500 text-center py-4">Carregando artistas...</div>
        )}
      </section>
